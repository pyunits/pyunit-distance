...
# @Email: jtyoui@qq.com
from decorators import replace_regular
import hashlib
...
def sim_hash_similarity(text1: (str, dict), text2: (str, dict), weight: dict = None, f: int = 64) -> float:
    """
    海明距离
...
if __name__ == '__main__':
    ...
    print(ham_distance(a, b, weight={"电影": 3}))  # 3
    print(sim_hash_similarity(''.join(a), ''.join(b)))  # 0.78125
