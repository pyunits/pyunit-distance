...
[![](https://img.shields.io/badge/字符串距离-distance-black.svg)]()
...
```python
from pyunit_distance import chebyshev_distance  # 切比雪夫距离
from pyunit_distance import cosine  # 余弦距离
from pyunit_distance import edit_distance  # 编辑距离
from pyunit_distance import euclidean_distance  # 欧氏距离
from pyunit_distance import ham_distance  # 海明距离
from pyunit_distance import mahalanobis_distance  # 马氏距离
from pyunit_distance import manhattan_distance  # 曼哈顿距离
from pyunit_distance import minkowski_distance  # 闵可夫斯基距离
from pyunit_distance import jaccard_set_distance, jaccard_distance  # 杰卡德距离
from pyunit_distance import bray_curtis_distance  # 布雷柯蒂斯距离
...
```python
from pyunit_distance import sim_hash_similarity
...
if __name__ == '__main__':
    ...
    print(sim_hash_similarity(text1, text2))
```
